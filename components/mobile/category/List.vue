<template>
  <swiper :slides-per-view="3" :space-between="20" class="mySwiper py-2 px-2">
    <swiper-slide v-for="item in items" :key="item.id" class="w-auto">
      <mobile-category-item :id="item.id" :name="item.name" :icon="item.icon" />
    </swiper-slide>
  </swiper>
</template>
...
const items = [
  {
    ...
    icon: {
      ...
      png_url:
        "https://cdn.alibaba.ir/ostorage-ugc/randd-threepio/d8028a23f2e8154bf0bfda920951c52038537299b63312ecc92a6069a88681fe_original.png",
    },
    default_phrase: "اقامت و هتل",
  },
  {
    id: "612b815e2d28e7b40b49aeb4",
    short_id: "8e6a4f28",
    parent_id: "",
    slug: "shopping",
    name: "بازار و خرید",
    icon: {
      ...
      png_url:
        "https://cdn.alibaba.ir/ostorage-ugc/randd-threepio/e8e5ccd5cdee6dd856b2ec8f909c44b166fc4dcfb10d250daffbb3fc73a937ee_original.png",
    },
    default_phrase: "بازار و خرید",
  },
  {
  ...
  },
  {
    ...
    icon: {
      ...
      png_url:
        "https://cdn.alibaba.ir/ostorage-ugc/randd-threepio/7edf6fd46dc4d08fe2af0a408a339ee1a951ccbca1124ce9c076127ef59ca884_original.png",
    },
    default_phrase: "خورد و خوراک",
  },
];
</script>
